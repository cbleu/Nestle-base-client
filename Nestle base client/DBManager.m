...
-(void) exportDBtoCSV {
    ...
    // Set the database file path.
    NSString *sqLiteDb = [self.documentsDirectory stringByAppendingPathComponent:self.databaseFilename];
    
    
    if(sqlite3_open([sqLiteDb UTF8String], &database) == SQLITE_OK) {
        const char *sqlStatement = [[NSString stringWithFormat:@"SELECT * FROM clientInfo"] UTF8String];
        sqlite3_stmt *compiledStatement;
    ...
    NSError *error = nil;
    [csv writeToFile:[self.documentsDirectory stringByAppendingPathComponent:@"clientInfo.csv"]
